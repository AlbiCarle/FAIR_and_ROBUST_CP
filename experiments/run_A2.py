...
def run_counterfactual_experiment_A2(model, dataset, eps_values, lambd, alpha, agg="max", target_group=0):
    ...
    for eps in tqdm(eps_values):
        ...
        X_cal_adv, X_cal_cf_adv = generate_attacked_data(
            model,
            dataset.X_cal, dataset.y_cal,
            dataset.s_cal, dataset.s_index,
            eps, lambd,
        ...
        X_test_adv, X_test_cf_adv = generate_attacked_data(
            ...
            dataset.s_test, dataset.s_index,
            eps, lambd,
            target_group=target_group
        )
